...
public class OrientationWalkerShift {
	...
	public static void main(String[] args) {
		...
		p2.SetName("p2");
		p2.Value = new ComplexVector(8, 0, 
		...
		grdT1.Activations
				.add(new Activation(t1, "p2", TransitionOperation.MultiplyByRo, "p3", new UnitaryParameters(+1, 0)));
		grdT1.Activations
				.add(new Activation(t1, "p2", TransitionOperation.MultiplyByRo, "p4", new UnitaryParameters(+1, 1)));
		...
		grdT2.Activations
				.add(new Activation(t2, "p5", TransitionOperation.MultiplyByRo, "p7", new UnitaryParameters(+1, 0)));
		grdT2.Activations
				.add(new Activation(t2, "p5", TransitionOperation.MultiplyByRo, "p6", new UnitaryParameters(-1, 1)));
		...
		grdT3.Activations
				.add(new Activation(t3, "p3", "p7", "", TransitionOperation.ComplexVectorAdditionWithShiftPlus, "p2"));
		...
		grdT4.Activations
				.add(new Activation(t4, "p4", "p6", "", TransitionOperation.ComplexVectorAdditionWithShiftMinus, "p5"));
