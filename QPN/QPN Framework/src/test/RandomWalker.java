...
public class RandomWalker {
	...
	public static void main(String[] args) {
		...
		grdT1.Activations.add(new Activation(t1, "p1", "HxH", TransitionOperation.UnitaryMatrix, "p1"));
		...
		grdT2.Activations.add(new Activation(t2, "p1", "p2", "MPlus", "MMinus", TransitionOperation.MoveX, "p4"));
		...
		grdT3.Activations.add(new Activation(t3, "p1", "p3", "MPlus", "MMinus", TransitionOperation.MoveY, "p5"));
		...
		grdT4.Activations.add(new Activation(t4, "p4", TransitionOperation.Move, "p6"));
		...
		grdT5.Activations.add(new Activation(t5, "p5", TransitionOperation.Move, "p7"));
		grdT5.Activations.add(new Activation(t5, "p5", TransitionOperation.Move, "p3"));
